...
class BlockedBabysitterCardWidget extends StatelessWidget {
  final Babysitter babySitter;
  final AdminCubit cubit;
  const BlockedBabysitterCardWidget({super.key, required this.babySitter, required this.cubit});

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: ()=> context.push(BabysitterDetailsAsAdminPage(validationNotBlocked: false,babySitter: babySitter, cubit: cubit)),
      child: Container(
