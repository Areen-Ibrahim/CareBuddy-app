...
class ViewRatesOfParentScreen extends StatefulWidget {
  final ParentsCubit cubit;
  const ViewRatesOfParentScreen({super.key, required this.cubit});

  @override
  State<ViewRatesOfParentScreen> createState() => _ViewRatesOfParentScreenState();
}

class _ViewRatesOfParentScreenState extends State<ViewRatesOfParentScreen> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    debugPrint("Data ${widget.cubit.requestsWithReviews}");
                ...
                widget: ListView(
                  ...
                  children: [
                    ...
                    ListView.separated(
                      ...
                      itemBuilder: (context,index)=> RatingOverviewContainerWidget(name: "${widget.cubit.requestsWithReviews[index].babySitter.fName} ${widget.cubit.requestsWithReviews[index].babySitter.lname}", rate: widget.cubit.requestsWithReviews[index].rateOfBabysitter!.rate, comment: widget.cubit.requestsWithReviews[index].rateOfBabysitter!.comment, nationality: widget.cubit.requestsWithReviews[index].babySitter.nationality),
                    )
                  ],
                )
            );
